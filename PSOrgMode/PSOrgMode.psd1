@{
    ...
    GUID                   = 'c551afdf-80cf-469a-9ace-f6423a10952a'
    ...
    Copyright              = '(c) 2021 Tim Aldrich. All rights reserved.'

    # Description of the functionality provided by this module
    Description            = 'Convert objects to and from org-mode'
    ...
    # functions to export.
    FunctionsToExport      = "*" #  only all when testing.
    ...
    PrivateData            = @{
        ...
        PSData = @{
            ...
            # online galleries.
            Tags                       = @('text', 'markup', 'org-mode')

            # A URL to the license for this module.
            LicenseUri                 = 'https://creativecommons.org/licenses/by/3.0/legalcode'

            # Flag to indicate whether the module requires explicit user
            # acceptance for install, update, or save.
            RequireLicenseAcceptance   = $false

            # A URL to the main website for this project.
            ProjectUri                 = 'https://github.com/aldrichtr/PSOrgMode'
            ...
            # Identify the module as prerelease in online galleries
            PreRelease                 = ''
